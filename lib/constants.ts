export const faqs = [
    ...
    },
    {
        ...
        answer: 'Yes, completely free. Generate unlimited progressions, download unlimited MIDI files. No account required, no hidden fees, no watermarks.',
    },
    {
    ...
    },
    {
        ...
        answer: 'Yes. ChordGen understands genre context. You can prompt it with "lo-fi hip-hop", "jazz bebop", "EDM drop", "fingerstyle acoustic", "R&B neo-soul", "cinematic orchestral", or any other style. The AI uses music theory principles specific to each genre to generate progressions that feel authentic to that sound.',
    },
    {
    ...
    },
    {
        ...
        answer: 'Absolutely. Everything you create with ChordGen is yours. Use it in commercial releases, sync licensing, client work, or live performances. No attribution required.',
    },
    {
